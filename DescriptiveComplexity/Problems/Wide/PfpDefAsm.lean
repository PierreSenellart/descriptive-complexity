...
(`DescriptiveComplexity.Pfp.PfpData.varRuleF`), the evaluation's machineries
...
`DescriptiveComplexity.Pfp.PfpData.UVarArgsDef` says, field by field: the four
...
`DescriptiveComplexity.Pfp.PfpData.varArgsOf` meeting `UVarArgsDef`, which is a
statement about `DescriptiveComplexity.Problems.Wide.PfpArgs` alone.
-/
...
variable {L : Language.{0, 0}} {dt : PfpData L} {Q P : Type} [Fintype Q]
...
evaluation. This is `DescriptiveComplexity.Pfp.PfpData.progAsm`'s `rule` field,
