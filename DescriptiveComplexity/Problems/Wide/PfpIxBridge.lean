...
`hgateEnc` need: `DescriptiveComplexity.Pfp.PfpData.gate_trichotomy` is stated
...
`DescriptiveComplexity.Pfp.PfpData.gate_trichotomy` answers. -/
...
`DescriptiveComplexity.Pfp.PfpData.gate_trichotomy` read at a file whose
