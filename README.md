...
| **DP** | a Σ₁ and a Π₁ sentence conjoined: a difference of NP problems – Papadimitriou & Yannakakis; `NP ∪ coNP ⊆ DP ⊆ Σ₂ᵖ ∩ Π₂ᵖ` | — (SAT-UNSAT is defined and *in* DP; its hardness is not yet formalized) |
